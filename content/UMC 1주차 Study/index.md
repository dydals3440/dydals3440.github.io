...
이번에 아쉽게 베스트 워크북을 받지 못했다. PM / ios / Android / 백엔드 / 프론트엔드 다양한 분야에서 딱 1명만을 뽑기에 확실히 받기 어려운 것 같다. 다음 2주차에는 조금 더 열심히 과제를 해봐야겠다. 그리고 워크북 할 때마다 이제 계속 블로그에 올릴 생각인데 저작권을 신경써야겠다. 1주차 워크북도 추후에 바로 저작권을 위반한 부분은 수정하고, 양해를 구해야겠다.
